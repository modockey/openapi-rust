...
- API version: 1.0.0
- Build date: 2022-08-28T21:22:33.207475+09:00[Asia/Tokyo]
...
```
cargo run --example client IpGet
cargo run --example client IpPost
```
...
------------- | ------------- | -------------
[****](docs/default_api.md#) | **GET** /ip | 
[****](docs/default_api.md#) | **POST** /ip | 


## Documentation For Models

 - [IpGet200Response](docs/IpGet200Response.md)
 - [IpGetRequest](docs/IpGetRequest.md)
